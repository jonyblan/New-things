...
public class CityPassTester {
	...
	public static void main(String[] args) {
		...
		CityPass unlimitedCP = new UnlimitedCP(attractions, "Olivia",
		...
		CityPass limitedVisitsCP = new LimitedVisitsCP(attractions,
		...
		CityPass endDateCP = new EndDateCP(attractions, "Walter",
