...
public class MilesClientTester {
	...
	public static void main(String[] args) {
		...
		MilesClient chuck = new MilesClient("Chuck", 4, Club.TWO);
		...
		MilesClient sarah = new MilesClient("Sarah", 2, Club.ONE);
		...
		MilesClient morgan = new MilesClient("Morgan", 6, Club.FIVE);
